...
namespace ApiProjeKampi.WebApi.Controllers
{
    ...
    public class ReservationsController : ControllerBase     
    {
        ...
        public IActionResult CreateReservation(CreateReservationDto createReservationDto)
        {
            ...
            return Ok("Rezervasyon Ekleme İşlei Başarılı");
        }
        [HttpDelete]
        public IActionResult DeleteReservation(int id)
        {
            ...
            _context.SaveChanges();
            return Ok("Rezervasyon Silme İşlei Başarılı");
        }
        ...
        [HttpGet("GetPendingReservarions")]
        public IActionResult GetPendingReservarions()
        {
        ...
        public IActionResult GetReservationStats()
        {
            ...
            DateTime fourMonthsAgo = today.AddMonths(-6);
