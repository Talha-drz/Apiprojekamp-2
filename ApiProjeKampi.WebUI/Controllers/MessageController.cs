    ...
    public class MessageController : Controller
    {
            ...
            var requestData = new
            {
                ...
                messages = new[]
                {
                    new
                    {
                        ...
                        "müşteri memnuniyeti gözeten cevaplar veren bir yapay zeka aracısın. " +
        ...
        public async Task<IActionResult> SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            try
            {
                ...
                var traslateContent = new StringContent(translateJson, Encoding.UTF8, "application/json");
                var translateResponse = await client.PostAsync("https://router.huggingface.co/hf-inference/models/Helsinki-NLP/opus-mt-tc-big-tr-en", traslateContent);
